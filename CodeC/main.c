...
int main ()
{
  ...
  printf("*******************************************\n");
	...
	file_input_1 = fopen("inputSOBI_S1.txt","rb");
    file_input_2 = fopen("inputSOBI_S2.txt","rb");
	...
	// Openning output files
  	file_output_1 = fopen("outputSOBI_S1.txt","wb");
  	file_output_2 = fopen("outputSOBI_S2.txt","wb");
	...
	n2 = ftell(file_input_2)/sizeof(double);
	...
	separation_v0(input_1, input_2, output_1, output_2, nb_samples, time_delay, 18);
